# ─────────────────────────────────────────────────────────────
# Script: 00_slave_voyages_full_pipeline.R
# Purpose: Run the entire data cleaning pipeline from raw .sav file to final CSV exports
...
# ─────────────────────────────────────────────────────────────
# Description:
# This script runs the full sequence of scripts required to clean, structure, and validate
# the Slave Voyages dataset. It sources each modular script in order, from loading libraries
# to exporting final outputs and generating the Entity Relationship Diagram.
#
# Key tasks:
# - Load required libraries
# - Import and clean the original SPSS dataset
# - Split data into relational tables
# - Validate foreign key integrity and generate ERD
# - Summarize final outputs
#
# Output:
# - 9 cleaned relational tables (CSV)
# - Entity Relationship Diagram (SVG)
# - Console output confirming integrity and structure
# ─────────────────────────────────────────────────────────────
...
# ── End of 00_slave_voyages_full_pipeline.R ──